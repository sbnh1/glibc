...
static inline double twosum(double x, double y, double *e){
  if(__builtin_expect(__builtin_fabs(x)>__builtin_fabs(y), 1))
...
static inline double sumdd(double xh, double xl, double yh, double yl, double *e){
  double sl, sh;
  char o = __builtin_fabs(xh)>__builtin_fabs(yh);
...
static double __attribute__((noinline)) as_logd_accurate(double, double*, double*);
static double __attribute__((noinline)) as_sinpipid(double, double*);
static double __attribute__((noinline)) as_sinpipid_accurate(double, double*);
static double __attribute__((noinline)) as_lgamma_asym_accurate(double, double*, double*);

static __attribute__((noinline)) double as_lgamma_database(double x, double f){
...
static __attribute__((noinline)) double as_lgamma_accurate(double x){
  // polynomial coefficients for (lgamma(x)+ln(|x|))/x where x in [-0.25,0.25]
  static const double c0[][2] = {
    {-0x1.2788cfc6fb619p-1, 0x1.6cb90701fbf92p-58}, {0x1.a51a6625307d3p-1, 0x1.1873d891220dfp-56},
    {-0x1.9a4d55beab2d7p-2, 0x1.4c26d1b4d5994p-59}, {0x1.151322ac7d848p-2, 0x1.b5f9120fdaca6p-57},
    {-0x1.a8b9c17aa6149p-3, -0x1.2e826b9f2e3f2p-58}, {0x1.5b40cb100c306p-3, 0x1.4a79a5f96e16fp-59},
    {-0x1.2703a1dcea3aep-3, -0x1.63066fbe425d6p-57}, {0x1.010b36af86397p-3, -0x1.7438c20a423a8p-59},
    {-0x1.c806706d57db4p-4, -0x1.5a891c586f017p-58}, {0x1.9a01e385d5f8fp-4, 0x1.9eb2a3ca8e809p-59},
    {-0x1.748c33114c6d5p-4, -0x1.505ae0736c854p-58}, {0x1.556ad63243bc2p-4, -0x1.0cfd5c4f86f62p-58},
    {-0x1.3b1d971fc59e2p-4, -0x1.9a19a5ba46076p-61}, {0x1.2496df8320d56p-4, 0x1.51588f44e1564p-58},
    {-0x1.11133476e5f97p-4, -0x1.fb27c7d952db7p-59}, {0x1.00010064c948ap-4, 0x1.c2a9309d327a6p-60},
    {-0x1.e1e2d312e9abp-5, 0x1.beee6edc135cfp-59}, {0x1.c71ce3a414da2p-5, 0x1.7d6e71837bc1dp-62},
    {-0x1.af28a18673c39p-5, 0x1.df2c138661f9bp-60}, {0x1.9999b2dfca9bbp-5, -0x1.afb6a810fa7c2p-59},
    {-0x1.861874180c0f2p-5, -0x1.c7900b8893e2bp-59}, {0x1.745d2798dac6ap-5, 0x1.e962ae5d1c788p-61},
    {-0x1.642be2fd1947dp-5, 0x1.94490a4e3d6b4p-61}, {0x1.55545da95a50bp-5, 0x1.b56c4cc4dd96bp-63},
    {-0x1.47ba80f965799p-5, 0x1.3bcac9fdf0d1ap-60}, {0x1.3b24eb343ccefp-5, -0x1.83fb9b692b013p-61},
    {-0x1.2eba18fc9675p-5, -0x1.3069a0cc7e12dp-60}, {0x1.23b27295dc8b4p-5, 0x1.a6d42b2188101p-60},
    {-0x1.2136ba2a595c4p-5, -0x1.c2acae5604f9dp-59}, {0x1.191f0bce33ba9p-5, -0x1.8470cbefa841ap-61},
    {-0x1.b86662fc0fb81p-6, -0x1.236cd67b781c2p-60}, {0x1.9d6d718c336abp-6, 0x1.c632d9ae925d4p-60},
    {-0x1.9ea8d7c263a8p-5, -0x1.bdcf945212655p-59}, {0x1.9f461fd74cc3p-5, 0x1.5e5f99eb89ba4p-60}};

  // polynomial coefficients for lgamma(1.5 + x) where x in [-0.25,0.25]
  static const double b[][2] = {
    {-0x1.eeb95b094c191p-4, -0x1.346863f58b074p-58}, {0x1.2aed059bd608ap-5, 0x1.cd3d2ca77b58cp-63},
    {0x1.de9e64df22ef3p-2, -0x1.6d48ec99346d4p-57}, {-0x1.1ae55b180726cp-3, -0x1.959aeebbdcd5bp-59},
    {0x1.e0f840dad61dap-5, -0x1.599fc3f5e3ccp-59}, {-0x1.da59d5374a543p-6, -0x1.0628c37280b13p-63},
    {0x1.f9ca39daa929cp-7, -0x1.69f468b73daddp-67}, {-0x1.1a8ba4f0ea597p-7, -0x1.7d1edde63f06cp-61},
    {0x1.456f1ad666a3bp-8, -0x1.31d73594fa521p-62}, {-0x1.7edb812f6426ep-9, -0x1.5f45d321e0ae2p-64},
    {0x1.c9735ae9db2c1p-10, -0x1.827b962d41f07p-64}, {-0x1.148a319eec639p-10, 0x1.a64298294f3a5p-64},
    {0x1.517c5a1579f4p-11, -0x1.055841dae38a6p-67}, {-0x1.9eff1d1c8be2dp-12, -0x1.fba56c797e258p-67},
    {0x1.00c41c13e3352p-12, -0x1.9c7d468e4cbd4p-73}, {-0x1.3f6dff22a8ffep-13, 0x1.79e9e76cea415p-68},
    {0x1.8f36195536e0cp-14, -0x1.9de6ad54f6997p-70}, {-0x1.f4ea079eaf734p-15, -0x1.fed2cdd5ce819p-69},
    {0x1.3b5e73a6bf0cep-15, -0x1.b8bf8cedf2f5dp-70}, {-0x1.8e583400720b6p-16, -0x1.58007f65918dcp-70},
    {0x1.f88ed0371a528p-17, 0x1.ca095e5525ba6p-75}, {-0x1.40597e1beb94dp-17, 0x1.99bf6a1da80a1p-71},
    {0x1.97b2f3649dc6ap-18, 0x1.39d919c548f05p-72}, {-0x1.03fa905165ffep-18, 0x1.0e61588355356p-72},
    {0x1.4c8df9a3d368p-19, -0x1.7a6689d0b7dd2p-73}, {-0x1.a9bafae87dbd3p-20, 0x1.5777bb7ae251ap-74},
    {0x1.0b2f2a9e11fe8p-20, -0x1.cf209a5b02c67p-75}, {-0x1.567358802c384p-21, 0x1.c44014666f1c9p-75},
    {0x1.1219755496b17p-21, -0x1.b113ac02e4428p-75}, {-0x1.63804ffdcd648p-22, 0x1.ba1993b4ec9b7p-76}};
  ...
  if(x<0x1p-100){
    ...
    double e; fasttwosum(fh,2*fl,&e);
    if(e==0 && 1 + 0x1p-54 == 1 - 0x1p-54) fl *= 1 + __builtin_copysign(0x1p-52, fl)*__builtin_copysign(1, fll);
  } else if(x<0x1p-2){
    ...
    if(__builtin_fabs(x-0.5)<0x1p-2){
    ...
    } else if(__builtin_fabs(x-2.5)<0x1p-2){
    ...
    } else if(__builtin_fabs(x-3.5)<0x1p-2){
    ...
    } else if(__builtin_fabs(x-1)<0x1p-2){
    ...
    } else if(__builtin_fabs(x-1.5)<0x1p-2){
    ...
    } else if(__builtin_fabs(x-2)<0x1p-2){
      double lll, ll, lh = as_logd_accurate(x-1, &ll, &lll);
    ...
    } else if(__builtin_fabs(x-3)<0x1p-2){
      double l2ll, l2l, l2h = as_logd_accurate(x-2, &l2l, &l2ll);
      double l1ll, l1l, l1h = as_logd_accurate(x-1, &l1l, &l1ll);
      l1l = sumdd(l1l,l1ll, l2l,l2ll, &l1ll);
      l1h = fasttwosum(l1h, l2h, &l2h);
	...
	fl = sumdd(fl,fll, lh,0, &fll);
      ...
      if(sx<0) x = fasttwosum(x,1,&fl);
      fh = as_lgamma_asym_accurate(x, &fl, &fll);
    }
    if(sx<0){
      double phi = (sx<-0.5)?sx - __builtin_floor(sx):-sx;
    ...
    double e; fasttwosum(fh,2*fl,&e);
    if(e==0){
      double dfl = 1 + __builtin_copysign(0x1p-26,fl)*__builtin_copysign(0x1p-26,fll);
      fl *= dfl;
    }
  }
  ...
  if(__builtin_fabs(fh)<0x1.8p-2){
	...
	{0x1.694a6058a7858p-6, -0x1.1d8c8b9b4d80ep-61}, {0x1.1718d7ca09e5bp-6, 0x1.83195b07fd25p-60},
	{0x1.7339fe04b2764p-10, -0x1.48648f4a4bf9ep-64}, {0x1.8d32f682aa0bdp-11, -0x1.90953dadfba01p-66},
	{0x1.809f04ee6e0fap-14, -0x1.6100a3d177e7cp-68}, {0x1.48eaa81657361p-15, 0x1.42b86f83f623dp-70},
	{0x1.9297adb2def5ap-18, -0x1.0c295492288fdp-73}, {0x1.286fb8cbaebb5p-19, -0x1.ebf1f6a584b62p-77},
	{0x1.a92e0a5de4bc9p-22, -0x1.688db240a9a82p-76}, {0x1.1a9d4d8c6284ep-23, 0x1.08624c7186639p-78},
	{0x1.c4cd2594e91c9p-26, 0x1.a225e59cfef5dp-81}, {0x1.18737ec8e68aap-27, 0x1.6421ab9e4c553p-82},
	{0x1.e6028795be5c1p-30, -0x1.b4bd2f36bb0ddp-84}, {0x1.1eacaeb800afdp-31, -0x1.cedc75cbd8cc4p-87},
	{0x1.06bce9e1f6b9p-33, -0x1.0fb524fda64ebp-87}, {0x1.2bb110a516b79p-35, 0x1.2d7a224941f92p-90},
	{0x1.1e0024589b848p-37, 0x1.1a84fa416703dp-92}, {0x1.3ec6ebb4ba73p-39, -0x1.eb9cd73c631d9p-94},
	{0x1.3936af34a015p-41, -0x1.83b442df73674p-95}, {0x1.57d4ece262198p-43, 0x1.20b160178fca3p-97},
	{0x1.5b530d802ffffp-45, 0x1.8bb2ee582dbd1p-104}, {0x1.7c323d20053dp-47, -0x1.32d5dd28cac13p-103},
	{0x1.6131339e2b76ap-49, 0x1.4422b26549563p-104}, {0x1.b4f6aaa0d8886p-52, 0x1.796e66ee63a34p-106}};
      const double sc = 0x1p+3;
      double zl, zh = fasttwosum(x0[0]+sx, x0[1], &zl); zl += x0[2];
	...
	{-0x1.4185ac30c8bf2p-4, 0x1.f161263693e12p-59}, {0x1.f504accc9f19bp-7, -0x1.eacc0226c7208p-62},
	{-0x1.8588458207eacp-9, 0x1.4b51668f3dff4p-63}, {0x1.4373f7cc709b3p-11, -0x1.2474e20e777aep-66},
	{-0x1.12239bdd6c013p-13, 0x1.46df69aa3032cp-69}, {0x1.dba65e27421c4p-16, 0x1.36bfe12004625p-71},
	{-0x1.a2d2504d7e987p-18, 0x1.a6b6dfe9fa6f4p-75}, {0x1.7581739ee6087p-20, -0x1.23100aff1ab78p-77},
	{-0x1.506c65fad6188p-22, -0x1.17d1749eb738fp-77}, {0x1.318ef724f7814p-24, -0x1.6517edf27abc2p-82},
	{-0x1.17767260d9825p-26, -0x1.03e683dfe1d87p-82}, {0x1.011e34454ade3p-28, -0x1.2a844fd6e7622p-82},
	{-0x1.db8b9e6b1e0e1p-31, -0x1.f73094d7d4e4p-85}, {0x1.b9bab1fca321p-33, -0x1.89b7151db3448p-88},
	{-0x1.9bed46f4d0aa2p-35, -0x1.1af984f4b8e4p-90}, {0x1.81780d4242119p-37, -0x1.7576147eed5dcp-91},
	{-0x1.69d3ce15a3f87p-39, 0x1.9823fc1b6be9ep-93}, {0x1.5494a34ce847p-41, -0x1.0ec96907a37b4p-95},
	{-0x1.4160eccd5982ep-43, 0x1.2b4a92d7b0c76p-98}, {0x1.2fe0a640fb1ap-45, -0x1.b1f41cf9689edp-106},
	{-0x1.1ff8659402df5p-47, 0x1.511b4097b0fccp-104}, {0x1.1357a3e9e1cf1p-49, -0x1.bda0e37acdd97p-106},
	{-0x1.0b145c5c5b9abp-51, -0x1.b52b4002dbc0cp-105}, {0x1.dc1888c7036cap-54, 0x1.2a69b093c9a8bp-109},
	{-0x1.060b52b5d6f68p-56, 0x1.d17de397a2b1p-110}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.2d4p-4 && sx>-3.5 && sx<-3.0){
      static const double x0[] = {0x1.9260dbc9e59afp+1, 0x1.f717cd335a7b3p-53, 0x1.d32a2a65bfd63p-107};
      static const double c[][2] = {
	{0x1.f20a65f2fac55p+2, -0x1.1d258e4b0beb5p-53}, {0x1.9d4d2977150efp-2, 0x1.a04089578ae88p-56},
	{0x1.c1137124d5c5bp-6, 0x1.d6c922d2512d6p-61}, {0x1.267203d776b0ep-9, -0x1.aa6081d790e05p-63},
	{0x1.99a6337da39ddp-13, 0x1.49aeda9400147p-68}, {0x1.293c3f78d3bdbp-16, 0x1.ee59e48e8b181p-73},
	{0x1.bb97aa0b71e45p-20, -0x1.592602ea73795p-78}, {0x1.51ea3345f5349p-23, 0x1.ef9552f50f84ep-79},
	{0x1.057f65c64b21p-26, -0x1.36ca6c4396475p-80}, {0x1.99c8650e3a4f9p-30, 0x1.7d3b9d2266a1p-84},
	{0x1.44520c3a4f841p-33, 0x1.8c284070d32dfp-89}, {0x1.02d221961d8b5p-36, -0x1.0d56a1938ace2p-90},
	{0x1.9ffcd97899d22p-40, -0x1.d6040c8c03da8p-95}, {0x1.50494b6c20faap-43, -0x1.644c84757ab17p-97},
	{0x1.113fe94711cb9p-46, -0x1.f7b0588af7045p-100}, {0x1.be09d37bab523p-50, 0x1.0f8dbcb173a93p-106},
	{0x1.6d6b80656d502p-53, -0x1.9e5c21b32ebp-110}, {0x1.2ca70c7ef211ep-56, 0x1.6511b75c60833p-111},
	{0x1.f9264b4df26e4p-60, -0x1.aefcabcc01fd2p-121}, {0x1.9262efb57925p-63, -0x1.1196c645b5736p-117}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.efp-5 && sx>-4.0 && sx<-3.5){
      static const double x0[] = {0x1.fa471547c2fe5p+1, 0x1.70d4561291237p-56, -0x1.9e6fadbbc171ap-111};
      static const double c[][2] = {
	{-0x1.4b99d966c5647p+4, 0x1.9cba2450b0003p-50}, {0x1.f76deae0436bep-1, -0x1.5af99a1af2d4bp-55},
	{-0x1.d25359d4b2f38p-5, 0x1.10c02bb27b3e8p-60}, {0x1.e8f829f141aa5p-9, 0x1.4b3ff24054d7dp-65},
	{-0x1.116f7806d26d3p-12, -0x1.a2efbebc9bc45p-68}, {0x1.3e8f3ab9fc1f4p-16, 0x1.e3a4940cdb9f6p-70},
	{-0x1.7dbbe062ffd9ep-20, -0x1.2986222077472p-74}, {0x1.d2f76de7bd027p-24, -0x1.6c0ccf4d8669cp-78},
	{-0x1.2225fe4f84932p-27, 0x1.a38a5afc8eebap-82}, {0x1.6d12ae1936ba4p-31, -0x1.de21fabe6423p-86},
	{-0x1.cffc2a8f6492dp-35, 0x1.64881462031d6p-91}, {0x1.294e1bdd838bcp-38, 0x1.dcbb67f373f7dp-92},
	{-0x1.7fab625b2f2ffp-42, -0x1.e8527e1dc6098p-100}, {0x1.f211abe57d76p-46, 0x1.d65f8610deeeep-102},
	{-0x1.44f2a05f33c9dp-49, 0x1.3fb27bfc54f94p-106}, {0x1.a9e4622460be6p-53, 0x1.2f5912b9785cp-107},
	{-0x1.182776b50f5cfp-56, -0x1.d30d2e8d300a5p-110}, {0x1.722b65d64ddcp-60, -0x1.0ee84a196d89cp-114},
	{-0x1.f31305b4f263ep-64, 0x1.40fbdbf9d128ap-118}, {0x1.3db9842b31607p-67, 0x1.ee1ac155bab3ap-122}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1p-3 && sx>-4.5 && sx<-4){
      static const double x0[] = {0x1.0284e78599581p+2, -0x1.e78c1e9e43cfep-53, 0x1.2ac17bfd6be92p-108};
      static const double c[][2] = {
	{0x1.aca5cf4921642p+4, 0x1.a46a2e0d8fdfdp-51}, {0x1.44415cd813f8ep+1, 0x1.afdc2672876f4p-56},
	{0x1.559b11b2a9c7cp-2, 0x1.17b8ada982c18p-57}, {0x1.96d18e21aebdbp-5, -0x1.c2f2da6bea629p-62},
	{0x1.0261eb5732e4p-7, 0x1.3910ed6591782p-61}, {0x1.55e3dbf99eb3dp-10, -0x1.e2d04c05513dcp-64},
	{0x1.d14fe49c4e437p-13, -0x1.d3009aa4e3bb9p-67}, {0x1.433dce282da6ep-15, -0x1.6a33c9bb3cb85p-70},
	{0x1.c8399c7588ccfp-18, 0x1.6b47c3c6f3b7ap-73}, {0x1.45fbe666d9415p-20, 0x1.9aaef873df6f7p-75},
	{0x1.d68d794caf0cfp-23, -0x1.62f893b4b1c92p-80}, {0x1.56729dc75d1c6p-25, -0x1.9e28ba9f5e686p-79},
	{0x1.f5ec3352af509p-28, 0x1.63d11f1c09f18p-82}, {0x1.7205756353fb8p-30, -0x1.e4315fc28841bp-85},
	{0x1.122e7755f935bp-32, 0x1.e94449e4ce532p-90}, {0x1.982503f30184cp-35, 0x1.db16eb0f7f6e4p-89},
	{0x1.30f8c448c65bcp-37, -0x1.ba5e1bf8c5346p-95}, {0x1.c957f8be0461cp-40, 0x1.78aa87d33801bp-95},
	{0x1.57fe1f7e3454fp-42, -0x1.61a8ccec45dcap-96}, {0x1.035fcc6efbe53p-44, 0x1.454e6ac634253p-98},
	{0x1.87856bbe691edp-47, -0x1.92c14fb55274p-105}, {0x1.2b877971688d2p-49, 0x1.c72aa6bdd8e43p-104},
	{0x1.e30abef69866bp-52, 0x1.4e95354428576p-107}, {0x1.3f5a80dfa357ep-54, 0x1.dc7c678b87e2ep-108}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.08p-4 && sx>-5 && sx<-4.5){
      static const double x0[] = {0x1.3f7577a6eeafdp+2, -0x1.5de5eab7f12cfp-53, 0x1.4075f5e0494a2p-110};
      static const double c[][2] = {
	{-0x1.d224a3ef9e41fp+6, -0x1.9be272a13bcb6p-48}, {0x1.b533c678a3956p+2, -0x1.37da6a2b62e3cp-53},
	{-0x1.0d3f7fee65d34p-1, 0x1.e68bf720db9bep-55}, {0x1.752a6f5ac2726p-5, -0x1.16f2fc46d2a34p-62},
	{-0x1.13d5d163bd3f7p-8, -0x1.813df737e6e21p-62}, {0x1.a8c5c53458ca5p-12, 0x1.02a507fa1273dp-66},
	{-0x1.5068b3ed69409p-15, -0x1.8fc69d833eb31p-72}, {0x1.0ffa575ea7fe3p-18, 0x1.ab6c92ac78cc4p-75},
	{-0x1.bec12dd78a23p-22, 0x1.81392cb5ee3ap-76}, {0x1.7382570f0b3c5p-25, 0x1.6c165015a71c3p-79},
	{-0x1.380ebf6161ccep-28, -0x1.efc3933cb1d2cp-83}, {0x1.084de43d1a947p-31, -0x1.1fca46f4984d6p-85},
	{-0x1.c2d90dead7a34p-35, 0x1.b9c200207ddp-89}, {0x1.82d0afe1a76ap-38, -0x1.958789fbe4df9p-93},
	{-0x1.4d93cbb2d04c5p-41, -0x1.411bc9bf3a7ccp-95}, {0x1.20ea504f0c629p-44, -0x1.1c1a63ab9daddp-100},
	{-0x1.f6cb7ebb79bc2p-48, 0x1.f2f3b682d06fep-106}, {0x1.be565af661ea4p-51, 0x1.b54b6ecaea8d5p-108},
	{-0x1.78510a36bad6cp-54, -0x1.6935e8745afe8p-109}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.1p-4 && sx>-5.5 && sx<-5){
      static const double x0[] = {0x1.4086a57f0b6d9p+2, 0x1.95262b72ca9cap-55, 0x1.bd98d5e0861aap-109};
      static const double c[][2] = {
	{0x1.ed72e0829ae02p+6, -0x1.fdc1859ae9c53p-50}, {0x1.cecc32ec22f9bp+2, 0x1.b6ecc779b86fcp-53},
	{0x1.253d8563f7264p-1, -0x1.5cd273fbd9f05p-55}, {0x1.a225df2da6e63p-5, -0x1.fe9d0b1b4c66p-59},
	{0x1.3e01773762671p-8, -0x1.f0e1184c71c78p-62}, {0x1.f7d8d5bdcb186p-12, -0x1.d3eb6b34618fbp-66},
	{0x1.9a8d00c77a92cp-15, -0x1.107ec223e7938p-70}, {0x1.557fd8c490b43p-18, 0x1.d8ff4f1780ac1p-72},
	{0x1.209221a624132p-21, -0x1.990b9a98394afp-75}, {0x1.edc98d3bbeedfp-25, 0x1.58dea3f0bc5b9p-79},
	{0x1.aabd28e6c9a81p-28, -0x1.da694af0e0ffp-82}, {0x1.73de2dd1cfd61p-31, 0x1.4f223cad85a45p-85},
	{0x1.4651832f82e2ep-34, 0x1.98ad9bf65ef61p-92}, {0x1.200d84be7e1fcp-37, -0x1.5a13d3eb64f54p-93},
	{0x1.ff278dbfe563p-41, 0x1.7119b25262c2dp-100}, {0x1.c77e7644c5411p-44, 0x1.c21cc9e02459cp-99},
	{0x1.97c73d128923ap-47, -0x1.155bb925610d9p-102}, {0x1.74798cd59653bp-50, -0x1.90790da400208p-104},
	{0x1.436d37cbd1ac2p-53, 0x1.34f1a6c134053p-107}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.13p-3 && sx>-6 && sx<-5.5){
      static const double x0[] = {0x1.7fe92f591f40dp+2, 0x1.7dd4ed62cbd32p-52, -0x1.2071c071a2146p-108};
      static const double c[][2] = {
	{-0x1.661f6a43a5e12p+9, -0x1.0c437b83bc0ddp-45}, {0x1.f79dcb794f26fp+5, -0x1.ada8018ade6efp-52},
	{-0x1.d6e8088a19ffep+2, -0x1.2c08708631269p-53}, {0x1.ef5d308dbfc97p-1, 0x1.87cd5c0d349fap-58},
	{-0x1.15ea6b0ab529ep-3, 0x1.4ac7004538519p-66}, {0x1.44d54e9fe2397p-6, 0x1.f1ca84e1a96cp-62},
	{-0x1.8684e40cebb3dp-9, -0x1.19803482caec7p-64}, {0x1.df44c1d81c723p-12, -0x1.0ed2e1ad825e8p-67},
	{-0x1.2ac3053f4ee18p-14, -0x1.fe50dd710dd6bp-68}, {0x1.79226ae04a847p-17, -0x1.379839e0000d6p-75},
	{-0x1.e0dffb5f77ccbp-20, 0x1.a4015df3482b4p-74}, {0x1.35217890708e7p-22, 0x1.2875bd051d55ep-78},
	{-0x1.903aa9af5cf03p-25, -0x1.a619f5e70dc34p-83}, {0x1.04a103323cd6ap-27, 0x1.a260aa452be23p-83},
	{-0x1.552efc1ecd295p-30, -0x1.88a83f178c25p-84}, {0x1.c0a12b600b141p-33, -0x1.c3732154b52acp-89},
	{-0x1.281ce75ae916fp-35, -0x1.a96d8e0798081p-89}, {0x1.88411a65d3af4p-38, -0x1.0e8c83eb281a9p-92},
	{-0x1.049e79a4b5baap-40, -0x1.64caa9cfd44a2p-94}, {0x1.5b0f16f419f7bp-43, 0x1.74e160750d876p-102},
	{-0x1.ce70ccad93bc1p-46, 0x1.1b340ff57e754p-100}, {0x1.3a7c53f75547fp-48, -0x1.88a8d5ad25f3fp-102},
	{-0x1.c41c8d3e4c2c9p-51, 0x1.e4dd9e959c88bp-105}, {0x1.f82da393ec32ap-54, -0x1.65c64b7f7e325p-115}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.15p-3 && sx>-6.5 && sx<-6){
      static const double x0[] = {0x1.8016b25897c8dp+2, -0x1.27e0f49a4ba72p-54, 0x1.72e1ab15a4d03p-110};
      static const double c[][2] = {
	{0x1.69de49e3af2aap+9, 0x1.954b690943afcp-47}, {0x1.fce23484cfd1p+5, 0x1.8266e7580f08cp-49},
	{0x1.de503a3c37c4p+2, 0x1.9fa7459d62427p-53}, {0x1.f9c7b52558abbp-1, 0x1.b6896749474c1p-55},
	{0x1.1d3d50714416ap-3, 0x1.56020c7693337p-58}, {0x1.4f21e2fb9e06p-6, 0x1.9e1cfc6a7c13p-60},
	{0x1.9500994cd8a9ep-9, -0x1.ce1777b097bd6p-63}, {0x1.f3a2c23c19d79p-12, -0x1.972494ba4cd4dp-70},
	{0x1.39152652eb3aap-14, 0x1.8f85c4250ca8p-69}, {0x1.8d45f8be891dep-17, 0x1.41e12761b265ap-71},
	{0x1.fd3214a702b29p-20, -0x1.140076f8887f9p-74}, {0x1.490b476815d46p-22, -0x1.3c92eb9376d39p-81},
	{0x1.ac3b965280088p-25, -0x1.468539ffe88b5p-82}, {0x1.1851c43c40d43p-27, -0x1.6918e4fb64554p-82},
	{0x1.70dfb529f2c5ap-30, -0x1.b5dfdc2a8890dp-84}, {0x1.e791ef4ef8602p-33, 0x1.b20188eabd9e6p-90},
	{0x1.437e60f850abep-35, 0x1.b5786abafa12ep-89}, {0x1.aec29bcf6c8c1p-38, 0x1.774aed905f5cfp-92},
	{0x1.1fb22834000f1p-40, 0x1.705349812bcbap-95}, {0x1.811ce4ec7b869p-43, 0x1.8be5e35bce704p-99},
	{0x1.01e72b00fd763p-45, 0x1.c8c867f1090e3p-99}, {0x1.60a0a9eee14d8p-48, 0x1.ed307bf965e72p-106},
	{0x1.fdce60428ba59p-51, 0x1.268eaf9e15016p-106}, {0x1.1dcf4e3ac0033p-53, 0x1.bdbdd6256584p-108}};
      const double sc = 0x1p+12;
      double zl, zh = fasttwosum(x0[0]+sx, x0[1], &zl); zl += x0[2];
      double sh = zh * sc, sl = zl * sc;
      int n = sizeof(c)/sizeof(c[0]), k = 6;
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.34p-3 && sx>-7.0 && sx<-6.5){
      static const double x0[] = {0x1.bffcbf76b86fp+2, -0x1.853b29347b806p-57, 0x1.0fa018051dd41p-111};
      static const double c[][2] = {
	{-0x1.3abf7a5cea91bp+12, -0x1.8257b8abd02cep-42}, {0x1.8349a2550422dp+9, -0x1.c6f2ef4105b99p-45},
	{-0x1.3d91dadc98428p+7, 0x1.46605ff1fc41cp-48}, {0x1.24f3d636f3339p+5, 0x1.5966a8447ea56p-49},
	{-0x1.20427df1b3492p+3, -0x1.e9801a53bb06ep-52}, {0x1.2775e857fb69cp+1, 0x1.88bd494f9ea51p-53},
	{-0x1.377e70b463c13p-1, -0x1.2524c9cdd93dbp-55}, {0x1.4f3d28edba5cdp-3, 0x1.92d2ac40dac77p-60},
	{-0x1.6e8557168cf8ap-5, 0x1.0b5cf2a57fc71p-59}, {0x1.95bb17ce427a4p-7, -0x1.0f3a87df6aaa1p-66},
	{-0x1.c5ac12d48f7e4p-9, 0x1.1d042aabfd8fbp-63}, {0x1.ff816dad74e75p-11, 0x1.24594bf64f76dp-67},
	{-0x1.225f4a6a0c5b4p-12, -0x1.e1dd93bdafddap-66}, {0x1.4ba3e5c007209p-14, 0x1.a47689fcd5098p-70},
	{-0x1.7cb738040762cp-16, -0x1.f100cc43c4b52p-70}, {0x1.b701200fca8b8p-18, 0x1.d825b96ec4cebp-72},
	{-0x1.fc33bee21552cp-20, 0x1.096b388c1821dp-75}, {0x1.272cc14fa7a53p-21, 0x1.d22fcb28979f7p-76},
	{-0x1.57f61caeb3e48p-23, -0x1.03971054f5156p-79}, {0x1.91f102889ab68p-25, -0x1.b9949bdf154e2p-80},
	{-0x1.d641c300c655ep-27, -0x1.47bf835c77fc5p-82}, {0x1.1319b4831f0ep-28, -0x1.2688b8ef3d8f7p-84},
	{-0x1.4c01654897d29p-30, -0x1.5c8d35e08cb51p-86}, {0x1.a7ea9eb248f1ep-32, -0x1.346b798e3ef55p-86},
	{-0x1.8afe498da415bp-34, 0x1.3f02ddea04afbp-88}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.145p-3 && sx>-7.5 && sx<-7){
      static const double x0[] = {0x1.c0033fdedfe1fp+2, -0x1.20bb7d2324678p-52, -0x1.f5536678d69d3p-106};
      static const double c[][2] = {
	{0x1.3b407aa387bd1p+12, 0x1.da1e57343b1dbp-43}, {0x1.83e85daafbad6p+8, -0x1.f37538d99bd29p-46},
	{0x1.3e552b5e3c226p+5, -0x1.07b1550d11cf4p-49}, {0x1.25e42a45e905bp+2, 0x1.61a63054c47c5p-54},
	{0x1.216a3560743eep-1, 0x1.f5024887fdb9dp-57}, {0x1.28e1c70ef5313p-4, 0x1.3234af5080105p-59},
	{0x1.393e2bc330081p-7, -0x1.45ef9ada326bap-62}, {0x1.5164141f5ae6ap-10, -0x1.802404a8fab89p-65},
	{0x1.712b3a86e1bdfp-13, -0x1.b2f4283e8796ep-69}, {0x1.98fd36b906e08p-16, -0x1.c84ad8d8481b7p-70},
	{0x1.c9ae6ef6262f6p-19, 0x1.ff0ee333033bfp-73}, {0x1.02382a958b63dp-21, -0x1.99f49c2b45652p-75},
	{0x1.256845ec9b6b1p-24, 0x1.822bd9a29ab32p-80}, {0x1.4f5ff36087486p-27, -0x1.dc262e92f86f3p-82},
	{0x1.814f9ce48442fp-30, 0x1.544e6fd9ac4bep-84}, {0x1.bca89f844ac84p-33, -0x1.63ceb4f54c669p-87},
	{0x1.01946c9b7b26ap-35, -0x1.9b4cb6a88b6fcp-90}, {0x1.2b75936f37bc3p-38, -0x1.d8809500cd622p-94},
	{0x1.5d3d0a248647p-41, -0x1.061c56c047c1dp-95}, {0x1.98297f709854fp-44, 0x1.4cc4272ef2e04p-103},
	{0x1.dd4cc8e9d77b5p-47, 0x1.0103a0db6c049p-102}, {0x1.1ce46c495fa62p-49, 0x1.622087cd95f2ap-103},
	{0x1.678ec65743609p-52, -0x1.850d52cb53a9fp-107}, {0x1.5fe290153bcaap-55, 0x1.a8b6414621298p-109}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.76bp-3 && sx>-8 && sx<-7.5){
      static const double x0[] = {0x1.ffff97f8159cfp+2, 0x1.e54f415a91586p-55, 0x1.53a5d106f9a3ep-109};
      static const double c[][2] = {
	{-0x1.3af76fe4c2fabp+15, -0x1.7cc92f0b999ep-40}, {0x1.838e76caaf123p+12, 0x1.292e15f502d1fp-42},
	{-0x1.3de68b3256526p+10, 0x1.5456a490ea6e3p-44}, {0x1.255c052530c71p+8, -0x1.6700425996a73p-48},
	{-0x1.20c2a8418126ap+6, 0x1.1d5e3d82023c1p-50}, {0x1.28139342cefp+4, 0x1.0238cfdd7475dp-51},
	{-0x1.384066c322246p+2, 0x1.ce82f225b48d1p-53}, {0x1.502bc4dad47d3p+0, 0x1.f45416fab08dap-58},
	{-0x1.6faadfece0e3p-2, -0x1.6c5874c40cd48p-56}, {0x1.9724323c89909p-4, -0x1.27460acd35293p-58},
	{-0x1.c7684c96f243p-6, 0x1.5d749ebbd28fep-62}, {0x1.00d1f48743fb8p-7, 0x1.ad60125333897p-61},
	{-0x1.23af6dd470e5cp-9, -0x1.1d084246f0edap-64}, {0x1.4d416958eec41p-11, -0x1.dfeda2a7c037ep-67},
	{-0x1.7eb3eb405269fp-13, -0x1.95169511f695dp-69}, {0x1.b972ec5a016fp-15, 0x1.0a9a114630056p-69},
	{-0x1.ff35af33eaacp-17, -0x1.73922358a5b41p-71}, {0x1.290662f9abea1p-18, -0x1.8a5267d544bb7p-72},
	{-0x1.5a395633f9d69p-20, -0x1.377120c488d2ep-76}, {0x1.94b2a8f6b566ep-22, 0x1.685bd8f7318c7p-79},
	{-0x1.da517a6c7ab89p-24, -0x1.940f32a9a6413p-78}, {0x1.168992efa74a9p-25, -0x1.bb9b7bf492795p-81},
	{-0x1.4665c665b014ep-27, 0x1.91ef4857aca34p-81}, {0x1.7f49e136d0e91p-29, 0x1.9d7da1584fe9p-85},
	{-0x1.df48e4db635efp-31, -0x1.ac6dd06d9a112p-85}, {0x1.3665697708ddp-32, -0x1.e15f660c03e5bp-90},
	{-0x1.015f65348c21ap-34, -0x1.e45b91e0267cp-90}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.76cp-3 && sx>-8.5 && sx<-8){
      static const double x0[] = {0x1.000034028b3f9p+3, 0x1.f60cb3cec1cedp-52, -0x1.ea26620d6b1cap-106};
      static const double c[][2] = {
	{0x1.3b088fed67718p+15, -0x1.505613ba29893p-39}, {0x1.83a3893550edcp+12, 0x1.f52e3b240db3p-42},
	{0x1.3e0078db8ada4p+10, 0x1.506573eecc6e3p-44}, {0x1.257bec9464251p+8, 0x1.8c4ea8394aa1ep-49},
	{0x1.20e9ea0755a47p+6, -0x1.978e59e1a3d9fp-48}, {0x1.2843e1313c83bp+4, -0x1.50610d6737717p-55},
	{0x1.387bd6a785478p+2, -0x1.1f1fff3fa1b4bp-52}, {0x1.5074e788de77p+0, 0x1.aeeb83580ea25p-55},
	{0x1.7004dd990d7dap-2, 0x1.3f7f554ffc67p-59}, {0x1.9792ed5f6dfb4p-4, -0x1.1f23ec3a02887p-58},
	{0x1.c7f08cdaef32fp-6, -0x1.1e18e4c767dep-62}, {0x1.0125c81121f59p-7, -0x1.a6731270f4d3fp-61},
	{0x1.2416931f22d22p-9, -0x1.2bc2867243e45p-64}, {0x1.4dc0543bea659p-11, 0x1.635ca3a9b1a8dp-66},
	{0x1.7f501645b2fdep-13, -0x1.e45b9db4c768p-67}, {0x1.ba331549d971dp-15, 0x1.97379411be4a6p-69},
	{0x1.001110caa210fp-16, 0x1.68ce3f9f57bc4p-70}, {0x1.2997db55cba74p-18, -0x1.0f0fa5ac41b0ap-74},
	{0x1.5aec550050044p-20, 0x1.7fdca933bee56p-74}, {0x1.958ee8d69504p-22, 0x1.c28e192bc3ba4p-76},
	{0x1.db608c6ccccc8p-24, -0x1.71a440ef759bep-80}, {0x1.173059c7e38cfp-25, 0x1.40d18009e343fp-79},
	{0x1.4731fe682342cp-27, -0x1.535cdcf9e608bp-83}, {0x1.8043ec54aba15p-29, -0x1.62d6d36f1d19ep-84},
	{0x1.e08fc2d5d4ap-31, -0x1.6e4b1587c874ep-85}, {0x1.3742f9e468b63p-32, 0x1.4c5c5de4449bfp-88},
	{0x1.021df5d9d312dp-34, 0x1.b2da076b6955fp-90}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.99p-3 && sx>-9 && sx<-8.5){
      static const double x0[] = {0x1.1ffffa3884bdp+3, 0x1.ff90c9d2ae925p-53, -0x1.30c0efef78c04p-107};
      static const double c[][2] = {
	{-0x1.625edfc63db2fp+18, 0x1.da7fc3ed68f99p-37}, {0x1.ea8c150480a7ap+15, 0x1.344e4cbf6d2a1p-39},
	{-0x1.c4b30e4bc55c1p+13, -0x1.9ec40fdd810d7p-41}, {0x1.d5fe468dbbf03p+11, -0x1.80705f1856688p-43},
	{-0x1.043d21bc24decp+10, -0x1.b0db95c85f28bp-45}, {0x1.2c334ae535e1dp+8, 0x1.530b0b83f8e2p-46},
	{-0x1.64314b431cd64p+6, -0x1.5d7e4374b5c05p-49}, {0x1.af6ed589b3a86p+4, -0x1.622e836ea2287p-51},
	{-0x1.096e446edcfb4p+3, 0x1.f849c504338f9p-51}, {0x1.4aaf49e713c0cp+1, 0x1.bbab832e792a1p-53},
	{-0x1.a0246d9c1b57fp-1, -0x1.18f4c5d12b8b5p-56}, {0x1.0806315c1a365p-2, 0x1.074a0bafc599fp-58},
	{-0x1.515dd6b891094p-4, -0x1.bcca3edb6dc58p-59}, {0x1.b1a5fe76de3d4p-6, -0x1.f8d7b8e44c315p-63},
	{-0x1.182229539b98cp-7, 0x1.5c2ae71e11bfep-62}, {0x1.6b8b31630a98cp-9, -0x1.c5c500af742dap-65},
	{-0x1.d9a3c6789b8e8p-11, 0x1.7160288934ba5p-65}, {0x1.359c2ea889b3ep-12, 0x1.e44b62289b60bp-69},
	{-0x1.9606a9f683511p-14, -0x1.3a3c7889c7af5p-68}, {0x1.0af84fb66238ep-15, -0x1.3d487a70215dap-69},
	{-0x1.5ff88107d908ap-17, 0x1.0c4172ceada86p-73}, {0x1.d14070a537453p-19, 0x1.964ddb3dba2bap-73},
	{-0x1.33eaa64e4654ep-20, 0x1.e6deb19e51b4ep-74}, {0x1.957ef375ea2abp-22, 0x1.065699585b36cp-77},
	{-0x1.0cd5c9d34a242p-23, -0x1.6f2ed041b79a1p-77}, {0x1.836d31552e5d6p-25, -0x1.789b28b32b093p-79},
	{-0x1.19aeee4b34ef6p-26, -0x1.c45d882aaaep-81}, {0x1.eb1912eaced35p-29, 0x1.e9842f288e554p-84}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.99p-3 && sx>-9.5 && sx<-9.0){
      static const double x0[] = {0x1.200005c7768fbp+3, 0x1.b5b610ffb70d4p-54, 0x1.deb7ad09ec5eap-108};
      static const double c[][2] = {
	{0x1.626120391944p+18, 0x1.7d5e8272ce41dp-38}, {0x1.ea8f32fb7f586p+15, -0x1.345b1cc20d4a5p-39},
	{0x1.c4b75ee68e2bap+13, -0x1.812d7bcedccb5p-42}, {0x1.d6043fa1ffaa5p+11, -0x1.5a4eaff5f008ap-43},
	{0x1.04414411db7f4p+10, 0x1.d742c54011402p-44}, {0x1.2c3903ec9c90cp+8, 0x1.73da27a4b1b2p-46},
	{0x1.64393744bb9bdp+6, -0x1.482bcb016f26fp-48}, {0x1.af79ccdc71d33p+4, 0x1.0a7a439456745p-50},
	{0x1.0975db7d71fc6p+3, 0x1.bd477ffdd39f6p-51}, {0x1.4ab9cba1e3478p+1, 0x1.1c929f5a50618p-54},
	{0x1.a032f8f114635p-1, 0x1.92279b6d57eb2p-55}, {0x1.0810426bfa5a1p-2, 0x1.0cd3cd3381e06p-56},
	{0x1.516bc616eaf53p-4, -0x1.0ebc405b4871ap-58}, {0x1.b1b948b11a02dp-6, 0x1.8b0ffc5af8ce1p-60},
	{0x1.182f8343c9e61p-7, -0x1.de95c6fadf8bbp-61}, {0x1.6b9dacc2e40dp-9, 0x1.7d2afb82825d1p-63},
	{0x1.d9bd5c016a05ap-11, 0x1.afdd41ec7d841p-65}, {0x1.35ade3d85cd0ep-12, -0x1.5080702a55ab7p-66},
	{0x1.961f2d2659b02p-14, 0x1.f377d9fd7df3ap-68}, {0x1.0b0946f97b203p-15, 0x1.9ecb24ffa7674p-69},
	{0x1.600ffd56f5733p-17, 0x1.2ffa0ff103bfdp-71}, {0x1.d160f5b944255p-19, -0x1.6f04901227877p-75},
	{0x1.3401289d10771p-20, -0x1.b2fca86443a23p-76}, {0x1.959dec69f88edp-22, 0x1.1945258ad2d8p-76},
	{0x1.0ceb1d5fdcfdbp-23, -0x1.e1bf43eb8d61fp-77}, {0x1.838cdbbcfd467p-25, -0x1.948ada050fa52p-80},
	{0x1.19c71e9accac3p-26, 0x1.74cb4459f6b9p-81}, {0x1.eb4678e3fcf16p-29, -0x1.66454030f804fp-83}};
      const double sc = 0x1p+20;
      double zl, zh = fasttwosum(x0[0]+sx, x0[1], &zl); zl += x0[2];
      double sh = zh * sc, sl = zl * sc;
      int n = sizeof(c)/sizeof(c[0]), k = 6;
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.76bp-3 && sx>-10.0 && sx<-9.5){
      static const double x0[] = {0x1.3fffff6c0d7cp+3, -0x1.197cea8c42d7dp-51, -0x1.7072c5a292198p-105};
      static const double c[][2] = {
	{-0x1.baf7da5f3795dp+21, -0x1.16a79518c8367p-33}, {0x1.7f3e8791fa0d2p+18, -0x1.2aec811c9609ep-36},
	{-0x1.ba18befcaaa63p+15, -0x1.d18c4e260465p-39}, {0x1.1ede14765dc0cp+13, 0x1.13bc952384f0fp-41},
	{-0x1.8d1a9ab5a505p+10, -0x1.904ee4f738385p-46}, {0x1.1e4d8c35d22ccp+8, -0x1.3b56f0fecec54p-48},
	{-0x1.a8a191db109p+5, -0x1.11eec467fa814p-51}, {0x1.4174f65ff868p+3, 0x1.c939d4bfd1404p-51},
	{-0x1.ee6d90f2332c7p+0, 0x1.3b18f44783de9p-55}, {0x1.80fd3420fba09p-2, 0x1.55812b31052fbp-57},
	{-0x1.2ecd481762eaep-4, -0x1.d974aa28e0c7p-62}, {0x1.e04a0b28db4c5p-7, -0x1.f0d1f410ed5c5p-61},
	{-0x1.7f91af3f1200fp-9, 0x1.da2dc770582ddp-63}, {0x1.342652fcfe1b6p-11, -0x1.7744fdcaebcfap-66},
	{-0x1.f1a88f796a348p-14, 0x1.a8bb92c660ef4p-74}, {0x1.93a68769f8a0fp-16, -0x1.f24bb59f0e5dap-70},
	{-0x1.48af467f6d621p-18, 0x1.7948f005903cap-74}, {0x1.0c92181e40e32p-20, 0x1.65951755e7adfp-74},
	{-0x1.b842459ce40bfp-23, 0x1.4503ca5bb9422p-77}, {0x1.69db729e3b047p-25, -0x1.c0423483dea32p-79},
	{-0x1.2a3762889a1ebp-27, -0x1.c935e18265a7p-81}, {0x1.ec8fbfde50a33p-30, 0x1.98aa5e946ac0fp-89},
	{-0x1.95dcfae4547bcp-32, -0x1.c04aac4c4ba01p-87}, {0x1.4f21457a90c36p-34, -0x1.e01d7e3277c24p-88},
	{-0x1.26aacbe779418p-36, 0x1.e6b067bac93acp-92}, {0x1.0c603e5994262p-38, 0x1.d6144d3f2ef17p-93},
	{-0x1.38f713b1343d3p-41, -0x1.0c3eef336946bp-95}};
      ...
      fh = polydd(sh,sl, n-k,c, &fl);
      fh = muldd(zh,zl,fh,fl, &fl);
    } else if(__builtin_fabs(fh)<0x1.76bp-3 && sx>-10.5 && sx<-10.0){
      static const double x0[] = {0x1.40000093f2777p+3, 0x1.927b45d95e154p-52, 0x1.0780c21b6e452p-106};
      static const double c[][2] = {
	{0x1.baf825a0c63b2p+21, -0x1.20323f1015cdfp-35}, {0x1.7f3ec8ae05f2ep+18, 0x1.2aec80d23ccb8p-36},
	{0x1.ba192fa62a5c8p+15, -0x1.25660ae99a81cp-39}, {0x1.1ede75ef431bp+13, -0x1.a691cbd9c9bebp-41},
	{0x1.8d1b435ece20fp+10, 0x1.5b052a017c6d3p-47}, {0x1.1e4e1e218c99cp+8, 0x1.775895e089534p-46},
	{0x1.a8a28e596cccep+5, -0x1.aa094ee6e63a1p-49}, {0x1.4175d0d35b3d4p+3, -0x1.0cf2eb638feb3p-51},
	{0x1.ee6f0af10b985p+0, -0x1.7d3173e84c277p-54}, {0x1.80fe7b2913e68p-2, 0x1.58aa6aa5a2a1dp-56},
	{0x1.2ece6307c7cbp-4, 0x1.812bbc72b9bf4p-58}, {0x1.e04bf4be0259p-7, 0x1.b2fdc34bbffbep-62},
	{0x1.7f9356d1f8f5dp-9, 0x1.200577f2d649bp-63}, {0x1.3427c173faa4ep-11, 0x1.963e715185901p-65},
	{0x1.f1ab0995dd7aap-14, -0x1.982b6a256e922p-70}, {0x1.93a8ac07adde7p-16, 0x1.1938f0da933adp-70},
	{0x1.48b1212550a17p-18, -0x1.73810e7394decp-72}, {0x1.0c93b2c55f9b3p-20, 0x1.b11c8bd5d36cap-75},
	{0x1.b8450c2eb24f2p-23, 0x1.b77d60943d51ap-83}, {0x1.69ddd961f0eb9p-25, 0x1.26555b649e2b9p-80},
	{0x1.2a39767b036bdp-27, -0x1.ff547cf250c2cp-82}, {0x1.ec935873525f3p-30, -0x1.56d39c71ef428p-84},
	{0x1.95e014a90402ep-32, 0x1.ff041edd80219p-88}, {0x1.4f23f078ebd25p-34, 0x1.22e3191f74383p-89},
	{0x1.26ad387c7d522p-36, -0x1.0581274dbf44p-91}, {0x1.0c628e2dc8b58p-38, 0x1.4473a911adb21p-97},
  ...
  if(au < ubrd[0]){ // |x|<0.5
    *signgamp = 1 - 2*(t.u>>63);
	...
	-0x1.c8062dd09ec62p-4, 0x1.9a018c7345316p-4, -0x1.7578ea8068cc4p-4, 0x1.566b51c990008p-4};
      ...
      // -0.5<x<-0.03125 || 0.03125<x<0.5 and thus x+1 in [0.5, 0.96875] + [1.03125, 1.5] and covered by the
      ...
      if(__builtin_expect(j==4, 0)){ // treat the region around the root at 1
	z = -x;
	fh = mulddd(z, fh,fl, &fl);
      }
      eps = __builtin_fabs(fh)*8.3e-20;
      fh = sumdd(-lh,-ll, fh,fl, &fl);
	...
	fh = mulddd(z, fh,fl, &fl);
      ...
      if(__builtin_expect(j==10, 0)){ // treat the region around the root at 2
	z = ax - 2;
	fh = mulddd(z, fh,fl, &fl);
      }
...
double as_logd_accurate(double x, double *l, double *l_){
  static const struct {ushort c0; short c1;} B[] = {
    {301, 27565}, {7189, 24786}, {13383, 22167}, {18923, 19696}, {23845, 17361}, {28184, 15150},
      ...
      {42929, -5622}, {41522, -6786}, {39825, -7905}, {37848, -8982}, {35602, -10020},
      {33097, -11020}, {30341, -11985}, {27345, -12916}, {24115, -13816}, {20661, -14685},
  ...
  double o = r*t.f, dxl = __builtin_fma(r,t.f,-o), dxh = o-1;
  static const double c[][2] = {
    {0x1p+0, 0x1.a193d7f59d80ap-118}, {-0x1p-1, 0x1.8c7d7a8733406p-99},
    {0x1.5555555555555p-2, 0x1.55555554f571dp-56}, {-0x1p-2, -0x1.e516b5d7b8c15p-73},
    {0x1.999999999999ap-3, -0x1.97f2898534175p-57}, {-0x1.55555555554b5p-3, -0x1.3834d62d64ec4p-59},
    {0x1.249249248dbdcp-3, -0x1.8aa032979ebedp-58}, {-0x1.000004e71581bp-3, 0x1.2e7f17d1c0e63p-57},
    {0x1.c71e5ec7051f6p-4, 0x1.217ec3dcb2f03p-58}};
  dxh = fasttwosum(dxh,dxl, &dxl);
  double fl = dxh*(c[6][0] + dxh*(c[7][0] + dxh*(c[8][0]))), fh = polydd(dxh,dxl, 6,c, &fl);
  fh = muldd(dxh,dxl, fh,fl, &fl);
  double s2 = h1[i1][2] + h2[i2][2], s1 = h1[i1][1] + h2[i2][1], s0 = h1[i1][0] + h2[i2][0];
  double L0 = 0x1.62e42fefa38p-1*ed, L1 = 0x1.ef35793c76p-45*ed, L2 = 0x1.cc01f97b57a08p-87*ed;
  L0 += s2;
...
double as_sinpipid(double x, double *l){
  x -= 0.5;
  double ax = __builtin_fabs(x);
  double sx = ax*128;
  ...
  if(__builtin_expect(kx<2,0)){
    ...
    static const double cl[] = {0x1.9f9cb402bc42ap-1, -0x1.86a8e46ddf78dp-3, 0x1.ac644e7aa33e6p-6};
    double z = 0.5-ax, z2 = z*z, z2l = __builtin_fma(z,z,-z2);
    double fl = z2*(cl[0] + z2*(cl[1] + z2*(cl[2]))), fh = fasttwosum(c[0], fl, &fl), e;
    fl += c[1];
...
double as_sinpipid_accurate(double x, double *l){
  x -= 0.5;
  x = __builtin_fabs(x);
  x *= 128;
  ...
  static const double c[][2] = {
    {-0x1.3bd3cc9be45dep-12, -0x1.692b71366c792p-66}, {0x1.03c1f081b5ac4p-26, -0x1.32b342c5da62ep-80},
    {-0x1.55d3c7e3cbffap-42, 0x1.17fcb68af9aaep-98}, {0x1.e1f506890e556p-59, -0x1.56c9658a7cfd5p-114},
    {-0x1.a6d193ca649ap-76, 0x1.61669b56f0275p-134}};
  static const double s[][2] = {
    {0x1.921fb54442d18p-6, 0x1.1a62633145c07p-60}, {-0x1.4abbce625be53p-19, 0x1.05511c684796p-73},
    {0x1.466bc6775aae2p-34, -0x1.6dc0d14c26b21p-89},  {-0x1.32d2cce62bd86p-50, 0x1.2ba6dbc4b37cp-104},
    {0x1.50783487e6b5cp-67, -0x1.b77efed0f9c1fp-122}, {-0x1.e306ec8cf7c02p-85, 0x1.5d2601f85289ap-139}};

  double d2h = d*d, d2l = __builtin_fma(d,d,-d2h);
...
double as_lgamma_asym_accurate(double xh, double *xl, double *e){
  ...
  if(xh<0x1p120){
    ...
    if(xh>=48){
      static const double c[][2] = {
	{0x1.acfe390c97d69p-2, 0x1.3494bc9001766p-56}, {0x1.5555555555555p-4, 0x1.55555554133c7p-58},
	{-0x1.6c16c16c16c17p-9, 0x1.f4c03199d8517p-64}, {0x1.a01a01a01a016p-11, 0x1.fb315e77b4883p-66},
	{-0x1.381381380c1bp-11, -0x1.c4cc418316ed1p-65}, {0x1.b951e22dd8dfcp-11, 0x1.e8da392824ecfp-65},
	{-0x1.f6a875bb1ab7bp-10, 0x1.27c5fcbab6b5dp-64}, {0x1.a0a6926f4992p-8, -0x1.1f355cbf82229p-63}};
      l1x = sumdd(l1x,l2x, c[0][0],c[0][1], &l2x);
      fl = 0;
      fh = polydd(z2h,z2l, 7,c+1, &fl);
    } else if(xh>=14.5){
      static const double c[][2] = {
	{0x1.acfe390c97d69p-2, 0x1.3494bc9007f28p-56}, {0x1.5555555555555p-4, 0x1.5555554ad7655p-58},
	{-0x1.6c16c16c16c17p-9, 0x1.f4b73ea546bd4p-64}, {0x1.a01a01a01a01ap-11, -0x1.464e31b1a609ap-65},
	{-0x1.3813813813692p-11, 0x1.63676fd3c851ep-66}, {0x1.b951e2b143b5ep-11, 0x1.cfe48021143d1p-65},
	{-0x1.f6ab0d459cadbp-10, 0x1.770df5ee0beeap-64}, {0x1.a41a211f4e098p-8, -0x1.e00b3c1619519p-63},
	{-0x1.e41f97ad4634dp-6, 0x1.05ffdbc72560fp-60}, {0x1.6f15ef2b47719p-3, -0x1.5665cba69dbaap-57},
	{-0x1.5762c9f49fe25p+0, 0x1.afeff5294ad13p-54}, {0x1.2ea102098f818p+3, 0x1.609db97f1bc89p-51}};
      l1x = sumdd(l1x,l2x, c[0][0],c[0][1], &l2x);
      fl = 0;
      fh = polydd(z2h,z2l, 11,c+1, &fl);
    } else {
      static const double c[][2] = {
	{0x1.acfe390c97d69p-2, 0x1.3494bce9b5c5p-56}, {0x1.5555555555555p-4, 0x1.55551a0d18a1dp-58},
	{-0x1.6c16c16c16c17p-9, 0x1.07171d4a61bb9p-63}, {0x1.a01a01a01a008p-11, -0x1.49af39145d6ep-65},
	{-0x1.38138138124ccp-11, -0x1.b8f71068f5292p-66}, {0x1.b951e2b09b07p-11, -0x1.3c8a4c099ae72p-66},
	{-0x1.f6ab0d4de4a5cp-10, -0x1.fbb4ed542d17ep-65}, {0x1.a41a384fafd09p-8, 0x1.1510cc5dec148p-64},
	{-0x1.e4277d1a2b2e4p-6, 0x1.33cdd66b223e7p-61}, {0x1.6fdf731005805p-3, -0x1.a5a306692214p-57},
	{-0x1.641de6a9b2f1cp+0, 0x1.27cfac68728a3p-56}, {0x1.aa463d5553a9fp+3, 0x1.aeba9a5b525f3p-52},
	{-0x1.312d3aa56b6a2p+7, -0x1.2b2c4e643e5b9p-48}, {0x1.f3e8a4cd3d268p+10, -0x1.ec8b086b0215ep-45},
	{-0x1.ba9362f228307p+14, 0x1.b8ecae7dba56fp-40}, {0x1.8ed4df00421e4p+18, 0x1.c620cd11f44a5p-36},
	{-0x1.5af889993596dp+22, -0x1.23a78dbbfe515p-32}, {0x1.1789aff6ddc93p+26, 0x1.fe7e161d8bdb1p-29},
	{-0x1.94353def0e5f8p+29, -0x1.64a798491c211p-25}, {0x1.ffb9253861b9cp+32, -0x1.469d6acfea485p-23},
	{-0x1.159c1244c9ee4p+36, -0x1.f7491d4abcc7bp-19}, {0x1.f991ba9776c6ap+38, 0x1.cf2c83cfe2e55p-19},
	{-0x1.795f45ae3fa72p+41, -0x1.a777148d59de4p-13}, {0x1.c05845a910b48p+43, 0x1.433e08525d4bdp-11},
	{-0x1.96c399c145d71p+45, 0x1.d495c9370dc8ap-11}, {0x1.083bb9c79529bp+47, -0x1.1640e2de8cf9cp-8},
	{-0x1.b53232e707f4bp+47, 0x1.6d239acd71b5cp-8}, {0x1.59bad61bd81d5p+47, 0x1.0e3f2ea42a0ep-7}};
      l1x = sumdd(l1x,l2x, c[0][0],c[0][1], &l2x);
      fl = 0;
