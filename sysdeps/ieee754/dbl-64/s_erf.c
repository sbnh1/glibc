 ...
 */
 ...
 /* erfc integration based on commit 55e9869e */
...
/* __builtin_roundeven was introduced in gcc 10:
   ...
   static inline void two_sum(double *hi, double *lo, double a, double b) {
     *hi = a + b;
     double aa = *hi - b;
     double bb = *hi - aa;
     double da = a - aa;
   ...
   */
   ...
   cr_erf_accurate (double *h, double *l, double z)
   {
     ...
     *h = p[26]; /* degree-18 */
     for (int j = 17; j > 10; j--)
       *h = __builtin_fma (*h, z, p[8+j]); /* degree j */
     *l = 0;
     for (int j = 10; j > 7; j--)
     {
       /* multiply h+l by z */
   ...
   */
   ...
   static const double E2[] = {
     ...
     0x1.5555555555555p-3, 0x1.55555555c78d9p-57,   // degree 3
     0x1.5555555555555p-5, 0x1.55555545616e2p-59,   // degree 4
     0x1.1111111111111p-7, 0x1.11110121fc314p-63,   // degree 5
     0x1.6c16c16c16c17p-10, -0x1.f49e06ee3a56ep-65, // degree 6
     0x1.a01a01a01a01ap-13, 0x1.b053e1eeab9cp-73,   // degree 7
   ...
   #define LOG2tiny 0x1.f97b57a079a19p-103
     yh = __builtin_fma (-k, LOG2Hacc, xh);
